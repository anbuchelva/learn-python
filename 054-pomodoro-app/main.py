...
def start_timer():
    ...
    if reps % 2 == 0:
        ...
        counter_text = counter_text * int((reps % 8) / 2)
...
timer_label.config(font=(FONT_NAME, 30, "bold"), bg=YELLOW, fg=GREEN)
...
counter_label = Label(bg=YELLOW, fg=RED, font=(FONT_NAME, 20, "bold"))
